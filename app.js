$(document).ready(function () {
	...
	// compares the inputted summoner name with the participants by looping over all the participants, invoking findcd function if it matches
